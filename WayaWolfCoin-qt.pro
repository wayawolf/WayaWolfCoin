...
!win32 {
    ...
    LIBS += -lshlwapi
    genleveldb.commands = mkdir -p $$PWD/src/leveldb/build && cd $$PWD/src/leveldb/build && CC=$$QMAKE_CC CXX=$$QMAKE_CXX OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" cmake -DWIN32=1 -DCMAKE_TOOLCHAIN_FILE=../cross-compilation.cmake \ -DCMAKE_CROSSCOMPILING=1 -DRUN_HAVE_STD_REGEX=0 -DRUN_HAVE_POSIX_REGEX=0 -DCMAKE_BUILD_TYPE=Release .. && cmake --build . && cp libleveldb.a ..
}
...
UPSTREAM_INCLUDE_PATH = upstream/include
UPSTREAM_LIB_PATH = upstream/lib

# Set libraries and includes at end, to use platform-defined defaults if not overridden
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH $$UPSTREAM_INCLUDE_PATH
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) $$join(UPSTREAM_LIB_PATH,,-L,)
