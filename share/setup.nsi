...
!define COMPANY "WayaWolfCoin project"
!define URL http://www.wayawolfcoin.org/
...
OutFile wayawolfcoin-${VERSION}-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\WayaWolfCoin.lnk" $INSTDIR\wayawolfcoin-qt.exe
