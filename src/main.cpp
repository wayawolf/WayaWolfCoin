...
uint256 hashGenesisBlock("0xcb80d191d49404201c359f45795b16adfdddd774c75b48c2158e3a78e3b2ae4d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WayaWolfCoin: starting difficulty is 1 / 2^12
...
{
    // WayaWolfCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // WayaWolfCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // WayaWolfCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1477113903, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "JJW Treasures Growing 21 October 2016";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04db730f71c533147e95262049f991d8a2c7cb907eb11f7081b22d897eb38e5956f67f6b8bc94dbd90ef656033c32dfd9b08fc9164d70a78c83d039647be621335") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1477113903;
        ...
        assert(block.hashMerkleRoot == uint256("0x8f48e7e82f45abb4f5aa45acc3c1ec15bf415fa5a69885bf14bf8d40bd36d9f8"));
...
unsigned char pchMessageStart[4] = { 0xc2, 0x50, 0xc9, 0xb2 }; // WayaWolfCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WayaWolfCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WayaWolfCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static WayaWolfCoinMiner(CWallet *pwallet)
{
    printf("WayaWolfCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running WayaWolfCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WayaWolfCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&WayaWolfCoinMiner, pwallet));
}
