...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WayaWolfCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "WayaWolfCoin V2.0 08-16-2021";
        CTransaction txNew;
        txNew.nTime = 1629097342;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x515ee73c532381b30a15b39855e5b0c7fe5a4da5f851048e87cb2312d7f8bb1c"));
