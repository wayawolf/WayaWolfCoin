...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Oct 27 20:11:06 2016
# Project:  WayaWolfCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile WayaWolfCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/custom/wayawolfcoin-source/src/leveldb/libleveldb.a /tmp/custom/wayawolfcoin-source/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: WayaWolfCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile WayaWolfCoin-qt.pro
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /tmp/custom/wayawolfcoin-source/src/leveldb/libleveldb.a; cd /tmp/custom/wayawolfcoin-source/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/tmp/custom/wayawolfcoin-source/src/leveldb/libleveldb.a: FORCE
	cd /tmp/custom/wayawolfcoin-source/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/tmp/custom/wayawolfcoin-source/build/build.h: FORCE
	cd /tmp/custom/wayawolfcoin-source; /bin/sh share/genbuild.sh /tmp/custom/wayawolfcoin-source/build/build.h
